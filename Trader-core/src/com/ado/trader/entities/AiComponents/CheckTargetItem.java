...
public class CheckTargetItem extends TaskDecorator{

	public CheckTargetItem(AiSystem aiSys, Task task) {
		super(aiSys, task);
	}

	public CheckTargetItem(AiSystem aiSys, Task task, String name) {
