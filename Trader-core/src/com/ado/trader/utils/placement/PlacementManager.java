...
public class PlacementManager {
	...
	public void setPlacementSelection(String type, int id) {
		...
		case "wall":
			...
			break;
		case "zone":
			placementSelection = zonePl;
			if(id == 1){
				zonePl.workZone = true;
			}
			break;
		}
	}
	
	public void render(GameScreen game, SpriteBatch batch){
	...
	public ZonePlaceable getZonePl() {
		return zonePl;
	}
